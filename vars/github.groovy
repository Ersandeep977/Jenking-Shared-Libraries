...
{
  sh "ssh ubuntu@172.31.25.117 'rm -rf /var/lib/tomcat9/webapps/testapp.war'"
  sh 'scp ${WORKSPACE}/webapp/target/webapp.war ubuntu@172.31.25.117:/var/lib/tomcat9/webapps/testapp.war'
}
